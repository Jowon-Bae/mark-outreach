...
const INITIAL_TEAMS: Team[] = [
...

  {
    ...
    members: [
      ...
      { name: '김재연', role: '안내팀', phone: '010-0000-0000' },
      { name: '김수아', role: '안내팀', phone: '010-0000-0000' },
      { name: '박하솜', role: '안내팀', phone: '010-0000-0000' },
      { name: '심이안', role: '팀원', phone: '010-0000-0000' },
      { name: '이하은', role: '안내팀', phone: '010-0000-0000' },
      { name: '태현영', role: '안내팀', phone: '010-0000-0000' }
    ]
  },
