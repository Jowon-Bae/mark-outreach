...
const QT_DATA: Record<string, QTContent> = {
  ...
  '2026-07-16': {
    ...
    meditation: '사역을 준비하며 때로는 예상치 못한 영적 방해나 두려움을 마주할 수 있습니다. 그러나 만군의 여호와께서 친히 우리 편이 되어 주십니다. 사람이나 환경을 두려워하지 말고, 우리를 도우시는 하나님만을 굳게 믿고 기도로 담대히 나아갑시다.'
  ...
  '2026-07-17': {
    ...
    meditation: '에돔이 형제 나라 이스라엘이 망할 때 기뻐하며 원수를 갚은 것처럼, 우리도 때로 형제의 실패를 내심 기뻐할 때가 있습니다. 그러나 하나님은 그 교만과 악의를 반드시 심판하십니다. 아웃리치를 준비하며 함께하는 지체들을 경쟁자가 아닌 동역자로 여기며 사랑으로 섬겨 주님을 기쁘게 합시다.'
  },
  '2026-07-18': {
    passage: '에스겔 26:1~21',
    title: '남의 실패를 나의 성공으로 여기는 죄',
    verses: '“두로야 내가 너를 대적하여 바다가 그 파도를 굽이치게 함 같이 여러 민족들이 와서 너를 치게 하리니”',
    meditation: '두로는 예루살렘의 멸망을 보며 오히려 상업적 이익을 기대하며 기뻐했습니다. 형제의 실패를 나의 기회로 삼는 이 죄악은 오늘날도 우리 마음에 도사리고 있습니다. 다가오는 아웃리치 현장에서 우리가 만날 영혼들의 고통을 내 것처럼 여기도록 마음을 다듬고 기도로 준비하는 하루가 됩시다.'
  },
  '2026-07-19': {
    passage: '에스겔 27:1~25',
  ...
  '2026-07-20': {
    ...
    meditation: '두로의 상인들을 찬양했던 노래는 결국 통곡과 애도의 소리로 끝났습니다. 세상의 영광과 번영을 좇는 삶은 언제나 이처럼 허무한 결말을 맞습니다. 아웃리치를 준비하며, 오직 영원한 복음 위에 삶을 세우고 그 기쁨을 이 땅 영혼들과 함께 나누기를 소망합시다.'
  },
  '2026-07-21': {
    passage: '에스겔 28:1~19',
  ...
  '2026-07-24': {
    ...
    meditation: '바벨론 느부갓네살 왕은 스스로의 야욕으로 움직였지만, 하나님은 그를 교만한 애굽을 꺾는 도구로 사용하셨습니다. 하나님은 역사의 모든 권세와 사건을 주관하시며 당신의 뜻을 이루어 가십니다. 우리가 나아갈 아웃리치 현장도 하나님의 손 안에 있음을 믿고 기도로 담대히 준비합시다.'
  },
  '2026-07-25': {
    ...
    meditation: '하나님은 바벨론 왕의 팔은 들어주시고 애굽 바로의 팔은 꺾으셨습니다. 강하게도 하시고 약하게도 하시는 분은 오직 하나님뿐이십니다. 아웃리치를 기도로 준비하는 우리를 강하게 붙들어 주시는 하나님의 주권을 온전히 신뢰합시다.'
  },
  '2026-07-26': {
    passage: '에스겔 31:1~18',
  ...
  '2026-07-27': {
    ...
    meditation: '물을 흐려놓는 바로처럼, 우리도 모르는 사이에 주변을 혼탁하게 하는 삶을 살 수 있습니다. 아웃리치를 앞두고 우리의 언어와 행동과 태도가 맑고 깨끗하여, 만나는 영혼들에게 생수가 흘러넘치게 되기를 기도합시다.'
  },
  '2026-07-28': {
    passage: '에스겔 32:17~32',
    title: '교만으로 심판받은 죽은 자들의 세계',
    verses: '“할례를 받지 못하고 칼에 죽임을 당한 자가 거기에 있고 그 사방에는 그의 군대들의 무덤들이 있도다”',
    meditation: '강력했던 여러 나라들이 교만으로 인해 스올에 함께 누워 있습니다. 죽음 이후의 세계는 현세의 영광과 권세로 아무것도 할 수 없습니다. 다가올 아웃리치에서 우리가 만나게 될 영혼들이 영원한 생명을 얻게 되도록 열정을 다해 기도로 준비합시다.'
  },
  '2026-07-29': {
    passage: '에스겔 33:1~9',
    title: '생명을 구원하는 파수꾼의 역할과 사명',
    verses: '“그러므로 인자야 나는 너를 이스라엘 족속의 파수꾼으로 세웠으니 너는 내 입의 말을 듣고 나를 대신하여 그들에게 경고할지어다”',
    meditation: '하나님은 에스겔에게 파수꾼의 사명을 주셨습니다. 파수꾼이 나팔을 불어 백성을 경고하지 않으면 그 피값이 파수꾼에게 돌아옵니다. 우리도 복음을 들고 파수꾼의 사명을 가지고 나아갈 아웃리치를 온전히 기도로 준비합시다.'
  },
  '2026-07-30': {
    passage: '에스겔 33:10~20',
    title: '죄의 길에서 돌이키면 삽니다',
    verses: '“주 여호와의 말씀이니라 너희는 돌이키고 돌이키라 너희 악한 길에서 떠나라 이스라엘 족속아 어찌 죽고자 하느냐”',
    meditation: '하나님은 악인의 죽음을 기뻐하지 않으시고 돌이켜 사는 것을 원하십니다. 내일부터 시작될 아웃리치 현장에서 만나게 될 영혼들도 하나님의 이 뜨거운 마음처럼, 그들이 죄에서 돌이켜 영생을 얻게 되기를 간절히 기도하며 사역을 준비합시다.'
  },
  '2026-07-31': {
    ...
    meditation: '예루살렘 함락의 소식이 에스겔에게 전해졌습니다. 이스라엘의 실패와 멸망의 역사는 우리에게 반면교사가 됩니다. 오늘부터 본격적으로 시작되는 아웃리치 현장에서, 우리 삶에 하나님보다 높아졌던 것들을 모두 내려놓고 오직 생명의 말씀을 따라 온전히 쓰임 받기를 결단합시다.'
  },
  '2026-08-01': {
...
const DEFAULT_QT: QTContent = {
  ...
  meditation: '아웃리치 사역의 모든 능력의 원천은 바로 기도에 있습니다. 바쁜 일상과 준비 과정 중에서도 예수님처럼 한적한 곳에서 조용히 하나님을 마주하고, 기도로 마음을 다잡아 주의 은혜를 풍성히 누리는 시간이 됩시다.'
};
